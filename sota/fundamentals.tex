...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ RMFRD} \autocite{wangMaskedFaceRecognition2020} is presented in the context of the need of using a mask, mandated by the COVID-19 pandemic, and that greatly reduces the effectiveness of conventional face recognition methods. Therefore, there's was a need to improve their performance and for that a dataset that provides masked faces is needed. RMFRD pioneered this need by publishing a dataset consisting of 5 thousand masked and 90 thousand unmasked faces from 525 celebrities.
...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ CAFR} (rev 2021) \autocite{zhaoAgeInvariantFaceRecognition2022}
...
\begin{table}[!ht]
    \centering
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|l|c|c|c|l|c|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Dataset}} & \textbf{Year}             & \textbf{Availability} & \textbf{Images/vids}  & \textbf{Depth}        & \textbf{Breadth}      & \textbf{Distribution} & \textbf{Description}  \\ \hline
    ...
    Celeb-500k                             & 2018                      &                       & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &                       & \multicolumn{1}{l|}{} \\ \hline
    IMDb-Face                              & 2018                      &                       &                       &                       &                       &                       &                       \\ \hline
    QMUL-SurvFace                          & 2018                      &                       &                       &                       &                       &                       &                       \\ \hline
    MS1MV2                                 & 2019                      &                       & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &                       & \multicolumn{1}{l|}{} \\ \hline
    RMFRD                                  & \multicolumn{1}{l|}{2020} &                       & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &                       & \multicolumn{1}{l|}{} \\ \hline
    Glint360k                              & 2021                      &                       &                       &                       &                       &                       &                       \\ \hline
    CAFR                                   & 2021*                     &                       & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} & \multicolumn{1}{l|}{} &                       & \multicolumn{1}{l|}{} \\ \hline
    WebFace260M                            & 2021                      &                       &                       &                       &                       &                       &                       \\ \hline
    DigiFace-1M                            & 2022                      &                       &                       &                       &                       &                       &                       \\ \hline
    \end{tabular}%
    }
    \caption{}
    \label{tab:my-table}
...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ LFW}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ YTF}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ IJB-C} 

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ MegaFace}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ Trillion Pairs}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ DiF}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ Fair Face}
