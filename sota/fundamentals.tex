...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.15]{fc.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.38]{face_rec_pipeline.png}
...
\begin{table}[!ht]
    \centering
    \caption[Comparison of the test datasets.]{Comparison of the test datasets. \cmark - Datasets that are still available to the public. \xmark - Datasets that have been removed from distribution.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
    \hline
