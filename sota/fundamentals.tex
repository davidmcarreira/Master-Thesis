...
% \begin{figure}[H]
%     \centering
%     \includegraphics[scale=0.38]{face_rec_pipeline2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.75]{face_rec_pipeline2.eps}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[scale=0.5]{face_representation.png}
%     \caption[Face Representation pipeline.]{Face Representation pipeline, guided by the approach in~\autocite{wangDeepFaceRecognition2021}.}
%     \label{fig:frep pipeline}
% \end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.6]{face_representation.eps}
...
\begin{table}[H]
    \centering
    \caption[Comparison of the training datasets.]{Comparison of the training datasets. \cmark - Datasets that are still available to the public. \xmark  - Datasets that have been removed from distribution.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|c|c|c|c|c|l|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Dataset}} & \textbf{Year} & \textbf{Availability} & \textbf{Images/Videos} & \textbf{Depth} & \textbf{Avg. Breadth} & \textbf{Distribution} & \multicolumn{1}{c|}{\textbf{Description}} \\ \hline
    ...
    \textit{Facebook}~\autocite{taigmanWebscaleTrainingFace2015}                               & 2015          & \xmark                     & 500,000,000                 & 10,000,000            & 50                    & Private               & \begin{tabular}[c]{@{}l@{}}\textit{Facebook}'s private dataset used to test\\ different properties in face identification.\end{tabular}                 \\ \hline
    \textit{Google}~\autocite{schroffFaceNetUnifiedEmbedding2015}                                 & 2015          & \xmark                     & 200,000,000                 & 8,000,000             & 25                    & Private               & \begin{tabular}[c]{@{}l@{}}Private dataset used to train the FaceNet\\ method.\end{tabular}                 \\ \hline
    VGGFace~\autocite{parkhiDeepFaceRecognition2015}                                & 2015          & \xmark          & 2,600,000                 & 2,622          & 991.6                 & Public                & \begin{tabular}[c]{@{}l@{}}High width public dataset released\\ alongside VGGFace method.\end{tabular}                 \\ \hline
    MS-Celeb-1M~\autocite{guoMSCeleb1MDatasetBenchmark2016}                           & 2016          & \xmark          & 10,000,000                  & 100,000           & 100                   & Public                & Large-scale celebrities' dataset.                 \\ \hline
    MegaFace~\autocite{nechLevelPlayingField2017}                               & 2016          & \xmark                  & 4,753,320            & 672,057        & 7.1                   & Public                & Non-celebrity dataset.                 \\ \hline
    VGGFace2~\autocite{caoVGGFace2DatasetRecognising2018}                               & 2017          & \xmark                  & 3,310,000                & 9131           & 362.5                 & Public                & High characteristics variation dataset.                 \\ \hline
    ...
    Celeb-500k~\autocite{caoCeleb500KLargeTraining2018}                             & 2018          & \cmark                  & 50,000,000                  & 500,000           & 100                   & Public                & Noisy celebrities' dataset.                 \\ \hline
    Celeb-500k-2R~\autocite{caoCeleb500KLargeTraining2018}                          & 2018          & \cmark                  & 25,000,000                  & 245,000           & 102                   & Public                & Cleaned version.                 \\ \hline
    IMDb-Face~\autocite{wangDevilFaceRecognition2018}                              & 2018          & \cmark                  & 1,700,000                 & 59,000            & 28.8                  & Public                & \begin{tabular}[c]{@{}l@{}}Manually cleaned revision\\ of MS-Celeb-1M and MegaFace.\end{tabular}                 \\ \hline
    MS1MV2~\autocite{dengArcFaceAdditiveAngular}                                 & 2019          & \cmark                  & 5,800,000                 & 85,000            & 68.2                  & Public                & \begin{tabular}[c]{@{}l@{}}Semi-automatic cleaned version\\ of MS-Celeb-1M.\end{tabular}                 \\ \hline
    RMFRD~\autocite{wangMaskedFaceRecognition2020}                                 & 2020          & \cmark                  & 95,000                  & 525            & 180.9                 & Public                & \begin{tabular}[c]{@{}l@{}}Dataset of masked and unmasked\\ celebrities.\end{tabular}                 \\ \hline
    Glint360k~\autocite{anPartialFCTraining2021}                              & 2021          & \cmark                  & 17,000,000                  & 360k           & 47.2                  & Public                & \begin{tabular}[c]{@{}l@{}}Cleaned version of the Celeb-500k\\ and MS1MV2 datasets.\end{tabular}                \\ \hline
    WebFace260M~\autocite{zhuWebFace260MBenchmarkUnveiling2021}                            & 2021          & \cmark                  & 260,000,000                 & 4,000,000             & 65                    & Public                & \begin{tabular}[c]{@{}l@{}}Largest publicly available dataset\\ of celebrities faces (noisy).\end{tabular}                 \\ \hline
    WebFace42M~\autocite{zhuWebFace260MBenchmarkUnveiling2021}                             & 2021          & \cmark                  & 42,000,000                  & 2,000,000             & 21                    & Public                & Cleaned and smaller version.                 \\ \hline
    WebFace4M~\autocite{zhuWebFace260MBenchmarkUnveiling2021}                              & 2021          & \cmark                  & 4,2,000,000                 & 200,000           & 21                    & Public                & Smaller version.                 \\ \hline
    DigiFace-1M~\autocite{baeDigiFace1MMillionDigital2023}                            & 2022          & \cmark                  & 1,220,000                & 110k           & 11.1                  & Public                & Large-scale, fully synthetic dataset.                 \\ \hline
    \end{tabular}%
    }
...
\begin{table}[H]
    \centering
    \caption[Comparison of the test datasets.]{Comparison of the test datasets. \cmark - Datasets that are still available to the public. \xmark - Datasets that have been removed from distribution. * 153,428 are the number of the dataset's distractors.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|c|c|c|c|l|l|}
    \hline
    \multicolumn{1}{|c|}{\textbf{Dataset}} & \textbf{Year} & \textbf{Availability} & \textbf{Images/videos} & \textbf{Depth} & \textbf{Avg. Breadth} & \multicolumn{1}{c|}{\textbf{Description}} \\ \hline
    LFW~\autocite{huangLabeledFacesWild}                                    & 2007          & \xmark          & 13,233/-              & 5,749         & 2.3                  & \begin{tabular}[c]{@{}l@{}}The most well known face verification\\ public dataset.\end{tabular}                 \\ \hline
    YTF~\autocite{wolfFaceRecognitionUnconstrained2011}                                    & 2011          & \cmark                     & -/3,425                 & 1595            & 2.1                    & \begin{tabular}[c]{@{}l@{}}Face verification video dataset inspired\\ on the LFW.\end{tabular}                 \\ \hline
    IJB-A~\autocite{klarePushingFrontiersUnconstrained2015}                                  & 2015          & \xmark                     & 5,712/2,085                 & 500             & 11.4/4.2                    & \begin{tabular}[c]{@{}l@{}}Strays from accuracy saturation\\ by proposing a more challenging dataset.\end{tabular}                 \\ \hline
    CFP~\autocite{senguptaFrontalProfileFace2016}                                 & 2016          & \xmark          & 7,000/-                 & 500          & 14                 & \begin{tabular}[c]{@{}l@{}}Studies the effect of extreme pose\\ variations on face verification.\end{tabular}                 \\ \hline
    CPLFW~\autocite{zhengCrossPoseLFWDatabase}                                  & 2017          & \cmark                  & 13,233/-            & 5,749        & 2.3                   & \begin{tabular}[c]{@{}l@{}}Variation of the LFW for different poses\\ with refined verification pairs.\end{tabular}                 \\ \hline
    CALFW~\autocite{zhengCrossAgeLFWDatabase2017}                                  & 2017          & \cmark                  & 13,233/-                & 5,749           & 2.3                 & \begin{tabular}[c]{@{}l@{}}Same principles of CPLFW but applied\\ to age related tests.\end{tabular}                 \\ \hline
    AgeDB~\autocite{moschoglouAgeDBFirstManually2017}                                  & 2017          & \cmark                  & 16,488/-               & 568          & 29.0                   & \begin{tabular}[c]{@{}l@{}}Similar to CALFW but promotes noise\\ free labelling by doing it manually.\end{tabular}                 \\ \hline
    IJB-B~\autocite{whitelamIARPAJanusBenchmarkB2017}                                 & 2017          & \xmark                  & 21,798/7,011                  & 1,845           & 11.8/3.8                   & \begin{tabular}[c]{@{}l@{}}Improvement over the IJB-B dataset\\ (more data and more possible pairs).\end{tabular}                 \\ \hline
    TinyFace~\autocite{chengLowResolutionFaceRecognition2019}                               & 2018          & \cmark                  & 15,975 (153,428)*/-                  & 5,139           & 3.1                   & \begin{tabular}[c]{@{}l@{}}Genuine low resolution face recognition\\ benchmark.\end{tabular}                 \\ \hline
    IJB-C~\autocite{mazeIARPAJanusBenchmark2018}                                  & 2018          & \xmark                  & 31,334/11,779                 & 3,531            & 8.9/3.3                  & \begin{tabular}[c]{@{}l@{}}IJB-B refinement (more protocols\\ and increased individuals diversity).\end{tabular}                 \\ \hline
    IJB-S~\autocite{kalkaIJBIARPAJanus2018}                                  & 2018          & \xmark                  & 5,656/552                 & 202            & 28/2.7                  & \begin{tabular}[c]{@{}l@{}}Very challenging manually annotated\\ benchmark.\end{tabular}                 \\ \hline
    RFW~\autocite{wangRacialFacesWild2019}                                    & 2018 & \cmark                  & 40,607/-                  & 11,429            & 3.5                 & \begin{tabular}[c]{@{}l@{}}Benchmarks the racial bias of face\\ verification methods.\end{tabular}                 \\ \hline          
    QMUL-SurvFace~\autocite{chengSurveillanceFaceRecognition2018}                          & 2018          & \cmark                  & 463,507/-                  & 15,573            & 29.8                & \begin{tabular}[c]{@{}l@{}}Collected in uncooperative surveillance,\\ with high variance of characteristics.\end{tabular}                  \\ \hline
    MDMFR~\autocite{ullahNovelDeepMaskNetModel2022}                                  & 2021          & \cmark                  & 2,896/-                  & 226            & 12.8                 & \begin{tabular}[c]{@{}l@{}}Large scale dataset for masked\\ face recognition.\end{tabular}                 \\ \hline
    XQLFW~\autocite{knocheCrossQualityLFWDatabase2021}                                  & 2021          & \cmark                  & 13,233/-                  & 5,749           & 2.3                  & \begin{tabular}[c]{@{}l@{}}LFW variation to study the effect of\\ resolution on face verification.\end{tabular}                 \\ \hline
    CAFR~\autocite{zhaoAgeInvariantFaceRecognition2022}                                   & 2022          & \cmark                  & 1,446,500/-                  & 25,000            & 57.9                 & \begin{tabular}[c]{@{}l@{}}Large scale dataset to study the impact\\ of individual's age.\end{tabular}                 \\ \hline
    FaVCI2D~\autocite{popescuFaceVerificationChallenging2022}                                & 2022          & \cmark                  & 64,879/-                 & 52,411             & 1.2                    & \begin{tabular}[c]{@{}l@{}}Face verification dataset that addresses\\ easy pairs, demographic bias and\\ ethical concerns.\end{tabular}                 \\ \hline
    \end{tabular}%
    }
...
\newpage
\par One of the most well known test data set is LFW~\autocite{huangLabeledFacesWild}, but with the evolution of face recognition methods, it quickly became saturated in terms of accuracy reports. This motivated investigations to develop more challenging datasets, like A, B, C and S IJB benchmarks~\autocite{klarePushingFrontiersUnconstrained2015, whitelamIARPAJanusBenchmarkB2017, mazeIARPAJanusBenchmark2018, kalkaIJBIARPAJanus2018}, QMUL-SurvFace~\autocite{chengSurveillanceFaceRecognition2018}, YTF (for video tests)~\autocite{wolfFaceRecognitionUnconstrained2011}. For specific difficulties~\autocite{duElementsEndtoendDeep2022}, some examples are CPLFW~\autocite{zhengCrossPoseLFWDatabase} or CFP~\autocite{senguptaFrontalProfileFace2016} for cross-pose, CALFW~\autocite{zhengCrossAgeLFWDatabase2017} or AgeDB30~\autocite{moschoglouAgeDBFirstManually2017} for cross-age, RFW~\autocite{kalkaIJBIARPAJanus2018} for racial variations, XQLFW~\autocite{knocheCrossQualityLFWDatabase2021} for quality assessment or MDMFR~\autocite{ullahNovelDeepMaskNetModel2022} for masked recognition. Although some of the previously referenced datasets are designed for benchmarking and are described as such, they can also be generally employed to train or fine-tune algorithms for specific challenges.
\par For a more comprehensive description of the test datasets see \hyperref[appendix:test_data_appendix]{Appendix D}.
...
\noindent\textbf{$\rightarrow$ MixFaceNet}~\autocite{boutrosMixFaceNetsExtremelyEfficient2021} is a lightweight implementation of MixNet~\autocite{tanMixConvMixedDepthwise} tailored for face verification. MixNet introduced Mixed Depthwise Convolution Kernels \reffig{fig:mixconv} that extends the theory behind depthwise convolution, but employs multiple kernel sizes in a single convolution, promoting the capturing of different patterns from distinct resolutions while reducing the number of parameters needed. The main differences proposed by the MixFaceNet design, compared to MixNet, resides in the head and embedding settings. For the network head set-up, fast downsampling in the first convolution layer with a $3\times3$ kernel and stride of 2, and PReLU~\autocite{heDelvingDeepRectifiers2015} activation function are used. Regarding the embedding settings, the global average pooling layer used by the MixNet architecture is replaced by a global depthwise convolution, in the same manner as the previously described \hyperref[mobilefacenet]{MobileFaceNet}.
