...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ CFP} \autocite{senguptaFrontalProfileFace2016}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ MEGAFACE}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ CPLFW}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ CALFW}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ Age-DB}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ IJB-B}
...
\begin{table}[!h]
    ...
    IJB-A                                  & 2015          & -                     & 200M/-                 & 8M             & 25                    & Private               & temp                 \\ \hline
    CFP \autocite{senguptaFrontalProfileFace2016}                                 & 2016          & Discontinued          & 2,6M/-                 & 2,622          & 991.6                 & Public                & temp                 \\ \hline
    MegaFace*                              & 2016          & Discontinued          & 10M/-                  & 100k           & 100                   & Public                & temp                 \\ \hline
    CPLFW                                  & 2017          & temp                  & 4,753,320/-            & 672,057        & 7.1                   & Public                & temp                 \\ \hline
    CALFW                                  & 2017          & temp                  & 3,31M/-                & 9131           & 362.5                 & Public                & temp                 \\ \hline
    AgeDB                                  & 2017          & temp                  & -/22,075               & 3,107          & 7.1                   & Public                & temp                 \\ \hline
    IJB-B                                  & 2017          & temp                  & 50M/-                  & 500k           & 100                   & Public                & temp                 \\ \hline
