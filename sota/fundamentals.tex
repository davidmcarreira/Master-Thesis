...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ CAFR} (2019) \autocite{zhaoAgeInvariantFaceRecognition2022}
...
\begin{table}[]
    ...
    \hline
    \multicolumn{1}{|c|}{\textbf{Dataset}} & \textbf{Year} & \textbf{Aivailability} & \textbf{Images/vids} & \textbf{Depth} & \textbf{Breadth} & \textbf{Distribution} & \textbf{Description} \\ \hline
