...
\begin{table}[H]
    ...
    \hline
    \multicolumn{1}{|c|}{\textbf{Dataset}} & \textbf{Year} & \textbf{Availability} & \textbf{Images} & \textbf{Depth} & \textbf{Avg. Breadth} & \textbf{Distribution} & \multicolumn{1}{c|}{\textbf{Description}} \\ \hline
...
\begin{table}[H]
    ...
    IJB-A~\autocite{klarePushingFrontiersUnconstrained2015}                                  & 2015          & \xmark                     & 5,712/2,085                 & 500             & 11.4/4.2                    & \begin{tabular}[c]{@{}l@{}}Benchmark that aims at straying from accuracy\\ saturation by proposing a more challenging dataset.\end{tabular}                 \\ \hline
    ...
    IJB-S~\autocite{kalkaIJBIARPAJanus2018}                                  & 2018          & \xmark                  & 5,656/552                 & 202            & 28/2.7                  & Very challenging manually annotated benchmark.                 \\ \hline
    ...
    QMUL-SurvFace~\autocite{chengSurveillanceFaceRecognition2018}                          & 2018          & \cmark                  & 463,507/-                  & 15,573            & 29.8                & \begin{tabular}[c]{@{}l@{}}Dataset colected in uncooperative surveillance\\ scenarios, presenting high variance of characteristics.\end{tabular}                  \\ \hline
...
\par For a better description of the test datasets see \hyperref[appendix:test_data_appendix]{Appendix D}.
