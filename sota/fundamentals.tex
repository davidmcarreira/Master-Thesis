...
\par This step in the face recognition process can be accomplished through standalone methods that process the detected face from the previous stage, or through joint detection and alignment methods, as previously mentioned in the \hyperref[mt learning]{multi-task learning} definition.
