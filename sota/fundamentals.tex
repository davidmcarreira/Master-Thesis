...
To do:
\begin{itemize}
    \item Define hyperparameter
    \item Define epoch
    \item Calculate flops for all networks (in the ConvFaceNeXt paper)
\end{itemize}
}
