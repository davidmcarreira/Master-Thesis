...
\begin{table}[!ht]
    \centering
    \caption{Comparison table of the previously described test datasets. \cmark - Datasets that are still available to the public. \xmark - Datasets that have been removed from distribution.}
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|l|c|c|c|c|c|c|c|}
    \hline
