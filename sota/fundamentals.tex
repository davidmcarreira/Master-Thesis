...
\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ XQLFW} \autocite{knocheCrossQualityLFWDatabase2021}

\vspace{0.7\baselineskip}
\noindent\textbf{$\rightarrow$ FaVCI2D} \autocite{popescuFaceVerificationChallenging2022}
...
\begin{table}[!ht]
    ...
    QMUL-SurvFace \autocite{chengSurveillanceFaceRecognition2018}                          & 2018          &                       &                        &                &                       &                       &                      \\ \hline
    MDMFR \autocite{ullahNovelDeepMaskNetModel2022}                                  & 2021          &                       &                        &                &                       &                       &                      \\ \hline
    ...
    CAFR \autocite{zhaoAgeInvariantFaceRecognition2022}                                   & 2020          &                       &                        &                &                       &                       &                      \\ \hline
    \end{tabular}%
    }
    \caption{}
    \label{tab:test data}
