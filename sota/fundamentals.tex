...
% In the feature comparison step, the cosine similarity or equivalently L2 normalized Euclidean distance is used to measure the similarities between features \autocite{wangNormFaceL2Hypersphere2017}
